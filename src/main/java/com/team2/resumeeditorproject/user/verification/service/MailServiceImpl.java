...
import com.team2.resumeeditorproject.user.verification.repository.VerificationRepository;
...
public class MailServiceImpl implements MailService { // 인증코드를 생성하고 이메일을 보내는 서비스
	...
	private void sendEmailEnd(String fromM, String toM, String title, String content) { //이메일을 전송하는 메서드
